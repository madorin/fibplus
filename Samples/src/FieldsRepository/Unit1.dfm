object Form1: TForm1
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      AutoSize = False
      Caption = 
        'This Example demonstrate using FIBPlus FieldsRepository Technolo' +
        'gy. '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
  ...
  object Button1: TButton
    ...
    Caption = 'Show FIBPlus Fields Repository'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object dt: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '    CUS.ON_HOLD,'
        ...
        '    (SELECT COUNT(*) FROM SALES WHERE CUST_NO = CUS.CUST_NO) SAL' +
        'ES_QUANTITY'
      'FROM'
      '    CUSTOMER CUS')
  ...
  object DataSetsContainer1: TDataSetsContainer
    OnApplyFieldRepository = DataSetsContainer1ApplyFieldRepository
